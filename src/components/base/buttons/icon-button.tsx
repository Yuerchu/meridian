...
export interface IconLinkButtonProps extends Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'children'> {
  icon: IconComponent
  size?: IconButtonSize
  /** Accessible name — required since there is no visible label. */
  'aria-label': string
...
export function IconButton({
  ...
  return (
    <button ref={ref} type={type} className={cx(styles.base, styles.size[size], className)} {...props}>
...
export function IconLinkButton({ icon: Icon, size = 'medium', className, ref, ...props }: IconLinkButtonProps) {
  return (
