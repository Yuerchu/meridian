...
export function SegmentedControlItem({ className, children, ref, ...props }: SegmentedControlItemProps) {
  return (
    <AriaToggleButton
      ref={ref}
      {...props}
      className={(state) =>
        cx(
          ...
          state.isSelected
            ...
            : 'text-body-regular text-text-secondary data-[hovered]:text-text-primary',
