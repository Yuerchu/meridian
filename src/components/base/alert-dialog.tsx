    ...
    <DialogTrigger>
      ...
      >
        <AriaModal
          ...
          className="w-full max-w-md overflow-hidden rounded-2xl border border-border-button-default bg-background-primary-default shadow-dropdown outline-none data-[entering]:animate-in data-[entering]:fade-in-0 data-[entering]:zoom-in-95 data-[entering]:duration-200"
        >
          {children}
        </AriaModal>
      </ModalOverlay>
...
function AlertDialogHeader({ className, ...props }: ComponentProps<'div'>) {
  return <div data-slot="alert-dialog-header" {...props} className={cx('px-5 pt-4 pb-2', className)} />
}
...
function AlertDialogBody({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div data-slot="alert-dialog-body" {...props} className={cx('px-5 py-2 text-sm text-text-secondary', className)} />
  )
}
...
function AlertDialogIcon({ className, ...props }: any) {
  return <span data-slot="alert-dialog-icon" {...props} className={cx('flex shrink-0', className)} />
}
