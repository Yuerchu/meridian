...
export interface TextFieldProps extends Omit<AriaTextFieldProps, 'className'>, TextFieldContextValue {
  ...
  children?:
    | ReactNode
    | ((state: { isRequired: boolean; isInvalid: boolean; isDisabled: boolean; isReadOnly: boolean }) => ReactNode)
}
...
export function Input({
  ...
  return (
    <TextField
      ...
      aria-label={textFieldProps['aria-label'] ?? (!label && typeof placeholder === 'string' ? placeholder : undefined)}
    >
