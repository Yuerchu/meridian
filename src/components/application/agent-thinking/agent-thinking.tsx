...
function InfinityIndicator() {
  return (
    ...
    >
      <path d={INFINITY_PATH} fill="none" stroke="currentColor" strokeWidth={INFINITY_STROKE} opacity={0.15} />
      <path
        d={INFINITY_PATH}
        pathLength={100}
        fill="none"
...
export function AgentThinking({
  ...
  return (
    ...
    >
      ...
      <span aria-label={label} className={cx('text-body-medium', shimmer && 'bui-agent-thinking-label')}>
        {label}
      </span>
