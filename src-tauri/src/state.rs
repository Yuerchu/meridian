...
pub(crate) struct PendingApproval {
    ...
    pub(crate) bubble: Option<Bubble>,
...
pub(crate) struct Bubble {
    ...
    pub(crate) sub_conversation_id: String,
}
...
/// nothing.
#[derive(Default)]
pub(crate) struct AppSubAgentInboxes(std::sync::Mutex<HashMap<String, Arc<SubAgentInbox>>>);

#[derive(Default)]
pub(crate) struct SubAgentInbox {
...
impl AppSubAgentInboxes {
    ...
    pub(crate) fn close(&self, conversation_id: &str) -> Vec<crate::agent::engine::Steered> {
