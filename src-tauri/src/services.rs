...
#[derive(Clone)]
pub(crate) struct Services(Arc<ServicesInner>);

pub(crate) struct ServicesInner {
    pub(crate) db: DbPool,
    pub(crate) secrets: Arc<SecretsManager>,
    pub(crate) tools: Arc<tools::ToolRegistry>,
    ...
    pub(crate) mcp: Arc<mcp::McpRegistry>,
    ...
    pub(crate) turns: Arc<TurnCoordinator>,
    pub(crate) approvals: ApprovalWaiters,
    pub(crate) sub_agent_inboxes: AppSubAgentInboxes,
    pub(crate) compact_breakers: Mutex<HashMap<String, Arc<CompactCircuitBreaker>>>,
    pub(crate) voice: VoiceState,
    pub(crate) sleep: AppSleepInhibitor,
    pub(crate) events: EventBus,
    pub(crate) paths: Paths,
}

impl Services {
    pub(crate) fn new(inner: ServicesInner) -> Self {
